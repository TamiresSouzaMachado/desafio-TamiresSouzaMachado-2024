...
Olá!
Fiz meu desafio com os conhecimentos que tenho, estou iniciando e ainda não domino a linguagem javascript e/ou outras linguagens.

Sei que não correspondi ao que foi pedido, mas fiquei feliz em conseguir montar uma lógica e aplicar os comandos que sei, e pelo menos, funcionaram!

Foi um desafio pessoal, meu primeiro teste, onde me dediquei muito.

Obrigada pela oportunidade em participar.

## Testando o código

O código está em HTML

Para testar a funcionalidade do código, abrir com LIVE SERVER
>botão direito do mouse > open with live server

Digitar os nomes e quantidades de animais.
>o código está configurado para aceitar as informações estabelecidas no desafio, e apresentar erro para o que foge delas.
